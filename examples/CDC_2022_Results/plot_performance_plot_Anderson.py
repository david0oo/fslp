...
# df_fpsqp = pd.read_pickle('feasible_slp_stats_crane_wIPOPT14-03-2022.pkl')
# df_fpsqp = pd.read_pickle('feasible_slp_stats_crane_wIPOPT20-03-2022.pkl')
# df_fpsqp_2 = pd.read_pickle('feasible_slp_stats_crane_wCPLEX_T426-03-2022.pkl')
df_fpsqp = pd.read_pickle('fslp_stats_crane_08-09-2022.pkl')
df_fpsqp_anderson_m1 = pd.read_pickle('fslp_stats_crane_wAndersonm1_08-09-2022.pkl')
df_fpsqp_anderson_m5 = pd.read_pickle('fslp_stats_crane_wAndersonm5_12-09-2022.pkl')
