...
if solve_str == 'ipopt':
    ...
    # # # opts['subproblem_sol_opts'] = {'nWSR':5000, "schur":True, "printLevel": "none", "enableEqualities":False, "linsol_plugin":"ma27", "max_schur":200}
    # opts['subproblem_sol_opts'] = {'nWSR':10000, "sparse":True, 'hessian_type': 'semidef'}
    opts['subproblem_sol_opts'] = {'nWSR':10000, "printLevel": "none", "sparse":True, 'hessian_type': 'semidef'}
elif solve_str == 'clp':
    opts = {}
